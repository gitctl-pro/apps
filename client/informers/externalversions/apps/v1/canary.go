	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.AppsV1().Canaries(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1().Canaries(namespace).Watch(context.TODO(), options)
			},
		},
		&appsv1.Canary{},
		resyncPeriod,
...
func (f *canaryInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&appsv1.Canary{}, f.defaultInformer)
}
