...
func (c *FakeApplications) Get(ctx context.Context, name string, options v1.GetOptions) (result *appsv1.Application, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(applicationsResource, c.ns, name), &appsv1.Application{})

	if obj == nil {
		return nil, err
	}
	return obj.(*appsv1.Application), err
}

// List takes label and field selectors, and returns the list of Applications that match those selectors.
func (c *FakeApplications) List(ctx context.Context, opts v1.ListOptions) (result *appsv1.ApplicationList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(applicationsResource, applicationsKind, c.ns, opts), &appsv1.ApplicationList{})
	...
	list := &appsv1.ApplicationList{ListMeta: obj.(*appsv1.ApplicationList).ListMeta}
	for _, item := range obj.(*appsv1.ApplicationList).Items {
...
func (c *FakeApplications) Create(ctx context.Context, application *appsv1.Application, opts v1.CreateOptions) (result *appsv1.Application, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(applicationsResource, c.ns, application), &appsv1.Application{})
...
func (c *FakeApplications) Update(ctx context.Context, application *appsv1.Application, opts v1.UpdateOptions) (result *appsv1.Application, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(applicationsResource, c.ns, application), &appsv1.Application{})
...
func (c *FakeApplications) UpdateStatus(ctx context.Context, application *appsv1.Application, opts v1.UpdateOptions) (*appsv1.Application, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(applicationsResource, "status", c.ns, application), &appsv1.Application{})
...
func (c *FakeApplications) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(applicationsResource, c.ns, name), &appsv1.Application{})
...
func (c *FakeApplications) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &appsv1.ApplicationList{})
	return err
}

// Patch applies the patch and returns the patched application.
func (c *FakeApplications) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *appsv1.Application, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(applicationsResource, c.ns, name, pt, data, subresources...), &appsv1.Application{})
